        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    Text(
                        "Aurora stores an offline reviewed synthesis. Check current local rules and professional guidance when a connection is available."
                    )
                    .font(.caption)
                    .foregroundStyle(.secondary)
                }
