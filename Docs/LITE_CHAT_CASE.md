...
Aurora provides a database-first offline incident path. Every Lite message
...
- `/tmp/AuroraDatabaseFirstPhysicalRetry.xcresult` records a physical test
...
- The signed Gemma 3 1B Q4_K_M development package `1.1.0` was rebuilt with the
  ...
  `/tmp/AuroraSubstantivePackageInstall.xcresult`.
