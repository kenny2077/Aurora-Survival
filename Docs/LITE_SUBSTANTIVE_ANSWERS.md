...
- The signed `1.1.0` package installed and activated on the physical iPhone 13;
  `/tmp/TrailGuardSubstantivePackageInstall.xcresult` records that pass.
...
- The retained generic-car clarification test exhausted its single repair and
  ...
  see `/tmp/TrailGuardSubstantivePhysical/Logs/Test/Test-TrailGuard-2026.08.09_23-26-20-+0800.xcresult`.
