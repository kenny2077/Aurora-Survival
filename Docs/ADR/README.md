...
| 0012 | Evaluation evidence is fully versioned |

Accepted decisions are binding until superseded by a new ADR. External evidence
requirements cannot be waived by editing an ADR.
