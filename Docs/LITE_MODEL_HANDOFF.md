...
Team iPhone 13. The model selects reviewed evidence; Aurora expands the
...
| Fuel-hazard model bypass | Pass: deterministic safety card, no native run | `/tmp/AuroraGemmaSafetyBypassPhysical.xcresult` |
| Apple Vision OCR to safety override | Pass | `/tmp/AuroraOCRSafetyPhysical.xcresult` |
