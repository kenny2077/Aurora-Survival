#!/usr/bin/env python3
"""Smoke-test TrailGuard's installed local Ollama development models.
...
creating a network dependency in TrailGuard Incident Mode.
"""
...
def generation_smoke(
    ...
    system = (
        "You are a TrailGuard development evaluator. Use only the supplied "
